    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="flex items-center justify-between px-10 h-[70px]">
        ...
        <div className="flex items-center gap-4 ">
          <button className="bg-black text-white px-5 py-2 rounded-lg w-[150px] h-[37px] items-center">
            login
          </button>
        ...
        <div className="w-[420px] bg-black text-white rounded-xl overflow-hidden">
          <div className="px-8 py-10 text-center">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg text-black mb-4 outline-none bg-white h-[44px]"
            />

            <button className="w-full bg-[#879F00] opacity-50 transition py-3 rounded-lg mb-6">
              Send login link
            </button>
